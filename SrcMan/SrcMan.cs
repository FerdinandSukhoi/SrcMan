...
namespace SrcMan
{
    ...
    public partial class SrcMan : IIoInteractive
    {
        ...
        public SrcMan()
        {
            ...
            {
                ConfigData =
                    JsonConvert.DeserializeObject<SrcManBase.Config>(File.ReadAllText(ConfigPath));
            }

            Db = new DbEngine(ConfigData ?? new SrcManBase.Config());
        ...
        public void Config()
        {
            if (ConfigData is null) ConfigData = new SrcManBase.Config();
